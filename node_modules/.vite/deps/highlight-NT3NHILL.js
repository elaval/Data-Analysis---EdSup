...
async function getParser(language) {
  ...
  switch (language) {
    ...
    case "ts":
    case "jsx":
      return (await import("./dist-U3Z3KDVJ.js")).parser.configure({ dialect: language });
    case "python":
      return (await import("./dist-R7ALIQZ3.js")).parser;
    case "html":
      return (await import("./dist-PIJ426MS.js")).parser;
    case "css":
      return (await import("./dist-R5MPPQIV.js")).parser;
    case "md":
      return (await import("./dist-O6BZXZZL.js")).parser;
  }
}
...
//# sourceMappingURL=highlight-NT3NHILL.js.map
