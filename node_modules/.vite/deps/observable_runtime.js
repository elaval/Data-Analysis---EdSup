  ...
  return {
    async next() {
      return {
        ...
        value: await (stale ? (stale = false, value) : new Promise((res, rej) => (resolve2 = res, reject = rej)))
      };
    },
    async return() {
      if (reject != null) {
  ...
  return {
    async next() {
      return {
        ...
        value: await (values.length ? values.shift() : new Promise((res, rej) => (resolve2 = res, reject = rej)))
      };
    },
    async return() {
      if (reject != null) {
...
var dot = () => import("./dot-TL5PMQBA.js").then((_2) => _2.dot);
var duckdb = () => import("https://cdn.jsdelivr.net/npm/@duckdb/duckdb-wasm@1.29.0/+esm");
var DuckDBClient = () => import("./duckdb-E4XHCI4Q.js").then((_2) => _2.DuckDBClient);
...
var Inputs = () => import("./inputs-YZJWP6TP.js");
var L = () => import("./leaflet-56BR5YZO.js");
var mapboxgl = () => import("./mapboxgl-KGLRO4OJ.js").then((_2) => _2.default);
var md = () => import("./md-2ARTMATA.js").then((_2) => _2.md);
var mermaid = () => import("./mermaid-2J65DAC6.js").then((_2) => _2.mermaid);
...
var tex = () => import("./tex-4Z3KE56H.js").then((_2) => _2.tex);
var topojson = () => import("https://cdn.jsdelivr.net/npm/topojson-client/+esm");
var vl = () => import("./vega-lite-VNJXGEIS.js").then((_2) => _2.vl);
